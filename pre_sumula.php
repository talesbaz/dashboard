...
<div class="container">
  <div class="section">
    ...
    <div class="row">
        <div class="col s12">
            <button class="btn red darken-4 waves-effect waves-light right" onclick="location.href='index.php?c=finaliza_sumula'" style="margin-left: 10px">Enviar <i class="mdi-content-send right"></i></button>
